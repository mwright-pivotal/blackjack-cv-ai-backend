...
class VideoPlayer:
    ...
    def __init__(self, source, size=None, flip=False, fps=None, skip_first_frames=0, scale=1):
        import cv2
    ...
    def __zoom(self, img, scale, center=None):
        import cv2
    ...
    def next(self):
        ...
        if self.scale != 1:
            frame = self.__zoom(frame, self.scale)
